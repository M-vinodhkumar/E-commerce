...
const Home = ({ addToCart, buyNow }) => {
    const products = [
        { id: 1, name: "Canon EOS R50", price: 999.0, image: "src/images/Canon.png", Description: "Canon EOS R50 24.2MP Mirrorless Camera (18-45 mm Lens, 5-Axis Electronic Image Stabilization)" },
