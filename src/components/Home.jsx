...
const Home = ({ addToCart, buyNow }) => {
    const products = [
        { id: 1, name: "Canon EOS R50", price: 999.0, image: "/src/assets/images/Canon.webp", Description: "Canon EOS R50 24.2MP Mirrorless Camera (18-45 mm Lens, 5-Axis Electronic Image Stabilization)" },
        { id: 2, name: "Sony A7 III", price: 1499.0, image: "/src/assets/images/303425_0_Xo4POLg9J.webp",Description: "SONY Alpha 6700M 26MP Mirrorless Camera (18-135 mm Lens, 23.3 x 15.5 mm Sensor, BIONZ XR Image Processor)" },
        { id: 3, name: "Nikon 50mm f/1.8", price: 199.0, image: "/src/assets/images/312192_cwlo5r.webp",Description: "Nikon Z 50II 20.9MP Mirrorless Camera (16-50 mm and 50-250 mm Lens, 23.5 x 15.7 mm Sensor, TFT Touch Sensitive LCD)" },
        { id: 4, name: "Action Camera", price: 299.0, image: "/src/assets/images/PCP_camera_righttype_action_16may2023_wyfttk.webp",Description: "GoPro Hero 4K and 12MP 60 FPS Waterproof Action Camera with Rear LCD Touchscreen (Black)" },
        { id: 5, name: "GoPro", price: 559.0, image: "/src/assets/images/300424_0_axpdwi.webp", Description: "GoPro Hero12 5.3K and 27MP 240 FPS Waterproof Action Camera with Voice Control (Black)" },
        { id: 5, name: "GoPro", price: 349.0, image: "/src/assets/images/263094_0_xmxxzf.webp", Description: "Insta360 X3 8K and 72MP 60 FPS Waterproof Action Camera with Magic Third Person Views (Black)" },
    ];
            ...
            <section className="relative bg-gray-900 text-white">
                <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center">
                    ...
                    <div className="flex-1 mt-10 md:mt-0">
                        <img src="/src/assets/images/head.webp" alt="Camera Hero" className="rounded-lg shadow-lg" />
                    </div>
                </div>
            </section>
